...
export default function ValoracionResenia() {
  return (
    <div className="space-y-6 bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg">
      ...
      {["sonido", "errores", "graficos", "historia", "requisitos", "precioCalidad", "recomendacion"].map((campo) => (
        <div key={campo}>
          ...
          <select name={campo} className={inputClass} required>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <input type="text" name="duracion_total" placeholder="Total (e.g. 20 horas)" className={inputClass} required />
          <input type="text" name="duracion_historia" placeholder="Historia" className={inputClass} required />
          <input type="text" name="duracion_secundarias" placeholder="Secundarias" className={inputClass} required />
        </div>
      </div>
      ...
      <div>
        ...
        <select name="dificultad" className={inputClass} required>
