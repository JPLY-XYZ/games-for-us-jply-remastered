...
function UserListCard({ user}) {
    ...
    return (
    <div className="bg-white dark:bg-slate-800 p-3 shadow rounded-md flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        {!isAdmin ?  (<div className="flex flex-col sm:items-end gap-2 w-full sm:w-auto">
            {/* Select de rol */}
        ...
        </div>): "NO TIENES PERMISO PARA REALIZAR CAMBIOS EN ESTE USUARIO"}
