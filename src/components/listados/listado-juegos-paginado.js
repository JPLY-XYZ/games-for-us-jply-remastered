...
export default function ListadoJuegoPaginado({ pageSize = 6, titulo = "Todos los Juegos", where = {}, isOwner = false }) {
  ...
  return (
    <div className="px-4 sm:px-8 ">
      <ListadoJuegos games={games} titulo={titulo} isOwner={isOwner} />
