...
export default async function Page({ searchParams }) {
    ...
    const renderMultimedia = () => {
        ...
        if (content.type === "RESEÑA" && content.urls?.imgs) {
            ...
            return (
                <>
                    ...
                    {/* Texto entre banner y otras imágenes */}
                    {content.text && (
        ...
        return (
            <div className="p-6 bg-white dark:bg-slate-900 rounded-lg shadow-lg">
                <ul className="space-y-4 grid grid-cols-1 md:grid-cols-2 gap-4 ">
                    ...
                    <li className="flex items-center  gap-2 justify-center md:justify-start space-x-4">
                        {iconMap["duracion"]}
                        Duracion:
                    ...
                    <li className="flex items-center gap-2 justify-center md:justify-start">
                        ...
                        <ul className="pl-6 list-none">
                            {valoraciones.jugabilidad.modos.map((modo, i) => (
                                <li key={i}>{modo}</li>
                            ))}
                        </ul>
                    </li>
                    ...
                    <li className="flex items-center gap-2 justify-center md:justify-start">
                        {iconMap["dificultad"]}
                        <span>Dificultad: {valoraciones.jugabilidad.dificultad}</span>
                    </li>
                    <li className="flex items-center gap-2 justify-center md:justify-start">
