...
export default async function Page() {
  ...
  return (
    <div className=" w-full p-4  text-black dark:text-white max-h-[calc(100vh-3.5rem)] h-[calc(100vh-3.5rem)]  ">
      <div className="flex flex-col lg:flex-row gap-4 h-full  ">
        {/* Columna izquierda (60%) */}
        <div className="w-full lg:w-3/5 flex flex-col gap-4 h-full pb-4">
  {/* Usuarios */}
  <section className="bg-[var(--aside-card-background)] rounded-2xl shadow p-4 flex flex-col gap-4 h-1/2 ">
  ...
  <section className="bg-[var(--aside-card-background)] rounded-2xl shadow p-4 flex flex-col gap-4 h-1/2">
    ...
    <div className="overflow-auto flex-grow space-y-3">
      {[{ titulo: "Cómo ganar en Apex", tipo: "Guía", autor: "Carlos Ramos", estado: "Pendiente" },
        ...
        <div className="w-full lg:w-2/5 pb-4 md:pb-0">
